...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/closes-Ten2N61_.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-D26LFGAh.mjs').then((m) => m.default || m)
  },
  {
    name: "sneakers",
    path: "/sneakers",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/sneakers-VN74EAK0.mjs').then((m) => m.default || m)
  }
];
